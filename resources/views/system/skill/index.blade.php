                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="searchFrom pull-right">
                                        <form action="{{ route('system.skill.index') }}" class="form-inline">
                                            <div>
                                            ...
                                            <a href="{{ route('system.skill.create') }}" class="btn btn-primary btn-action-create">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="action">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('system.skill.edit', [$item->id]) }}"
                                                                    class="dropdown-item">
                                                            ...
                                                            <li>
                                                                <btn-delete-confirm
                                                                    :message-confirm="{{ json_encode('このスキルを削除しますか？') }}"
                                                                    :delete-action="{{ json_encode(route('system.skill.destroy', [$item->id])) }}">
                                                                </btn-delete-confirm>
                                                            </li>
                                                        </ul>
                                                    </div>
