                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="searchFrom pull-right">
                                        <form action="{{ route('system.desired-cost.index') }}" class="form-inline">
                                            <div>
                                            ...
                                            <a href="{{ route('system.desired-cost.create') }}" class="btn btn-primary btn-action-create">
                            ...
                            @if (!$items->isEmpty())
                                ...
                                <table class="table table-responsive-sm table-striped">
                                    <thead class="table-dark">
                                        <tr>
                                            <th style="width:50%">
                                                @sortablelink('desired_cost_name', '希望単価名')
                                            </th>
                                            <th class="w-120">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="action">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('system.desired-cost.edit', [$item->id]) }}"
                                                                    class="dropdown-item">
                                                            ...
                                                            <li>
                                                                <btn-delete-confirm
                                                                    :message-confirm="{{ json_encode('この希望単価を削除しますか？') }}"
                                                                    :delete-action="{{ json_encode(route('system.desired-cost.destroy', [$item->id])) }}">
                                                                </btn-delete-confirm>
                                                            </li>
                                                        </ul>
                                                    </div>
