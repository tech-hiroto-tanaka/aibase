                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="searchFrom pull-right">
                                        <form action="{{ route('system.news.index') }}" class="form-inline">
                                            <div>
                                            ...
                                            <a href="{{ route('system.news.create') }}" class="btn btn-primary btn-action-create">
                                    ...
                                    <tbody>
                                        @foreach ($news as $new)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ PublishStatus::getDescription($new->news_publish_status) }}
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="action">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('system.news.edit', $new->id) }}"
                                                                    class="dropdown-item">
                                                            ...
                                                            <li>
                                                                <btn-delete-confirm
                                                                    ...
                                                                    :delete-action="{{ json_encode(route('system.news.destroy', $new->id)) }}">
                                                                </btn-delete-confirm>
                                                            </li>
                                                        </ul>
                                                    </div>
