                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="searchFrom pull-right">
                                        <form action="{{ route('system.area.index') }}" class="form-inline">
                                            <div>
                                            ...
                                            {{-- <a href="{{ route('system.area.create') }}" class="btn btn-primary btn-action-create">
                            ...
                            @if (!$items->isEmpty())
                                ...
                                <table class="table table-responsive-sm table-striped">
                                    <thead class="table-dark">
                                        <tr>
                                            <th>
                                                @sortablelink('area_name', 'エリア名')
                                            </th>
                                            <th class="w-120">
                                                都道府県名称
                                            </th>
                                            <th class="w-120">
                                                @sortablelink('order_number', 'ソート順序')
                                            </th>
                                            <th class="w-100">
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                @php
                                                    $arr = [];
                                                    foreach($item->areaPrefectures as $pref) {
                                                        if (!$pref->prefecture) {
                                                            continue;
                                                        }
                                                        $arr[] = $pref->prefecture->prefecture_name;
                                                    }
                                                @endphp
                                                <td>
                                                    {{ join('/', $arr) }}
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="action">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('system.area.edit', [$item->id]) }}"
                                                                    class="dropdown-item">
                                                            ...
                                                            <li>
                                                                <btn-delete-confirm
                                                                    :message-confirm="{{ json_encode('このエリアを削除しますか？') }}"
                                                                    :delete-action="{{ json_encode(route('system.area.destroy', [$item->id])) }}">
                                                                </btn-delete-confirm>
                                                            </li> --}}
                                                        </ul>
                                                    </div>
