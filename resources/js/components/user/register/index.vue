<template>
  <div class="container">
    <div class="fade-in page-register mt-5">
      <div class="logo-register">
        <a :href="data.urlTop" title="home">
          <img src="/assets/img/user/main_logo_white.svg" alt="" />
        </a>
      </div>
                ...
                <div class="card-body card-register">
                  <div class="row justify-content-center">
                    <div class="col-sm-12 text-center mb-4">
                      <h4 class="title-register">カンタン新規会員登録</h4>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center mb-3">
                    <hr />
                    <div class="col-12 col-sm-3 r-mb-1 font-15 lh-20">
                      性別
                      <span class="required">必镇</span>
                    </div>
                    <div class="col-12 col-sm-8 d-flex font-15">
                      <div
                        class="form-group me-3 custom-radio custom-radio-gender lh-20"
                        :key="item.id"
                  ...
                  <div class="row justify-content-center mb-3">
                    ...
                    <div class="col-12 col-sm-8">
                      <div class="d-flex">
                        <div class="form-group w-30 r-w-35">
                          <Field
                            type="hidden"
                            name="birthday"
                          ...
                          />
                          <label class="ms-3 font-16 lh-24">年</label>
                        </div>
                        <div class="form-group w-25 r-w-30">
                          <Field
                            ...
                            class="form-control d-inline"
                          />
                          <label class="ms-3 font-16 lh-24">月</label>
                        </div>
                        <div class="form-group w-25 r-w-30">
                          <Field
                            name="day"
                            ...
                            class="form-control d-inline"
                          />
                          <label class="ms-3 font-16 lh-24">日</label>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div class="list-option" :class="{ active: showOption }">
                      ...
                      >
                        <hr />
                        <div class="col-12 col-sm-3 r-mb-1 d-lbl">
                          <span class="lh27-5 font-15">希望就業時期</span>
                          <span class="no-required">任意</span>
                        </div>
                        <div class="col-12 col-sm-8 desired-work-radio font-15">
                          <div
                          ...
                          >
                            ...
                            />
                            <label :for="'desired_work_type_' + index">{{
                              item.label
                            }}</label>
                          </div>
                        </div>
                      ...
                      >
                        <hr />
                    <div class="col-12 col-sm-3 r-mb-1 d-lbl">
                      <span class="lh-20 font-15">経験スキル</span>
                      <span class="no-required">任意</span>
                    </div>
                    <div class="col-12 col-sm-8">
                      <div class="form-group">
                      ...
                      <div class="row justify-content-center mb-3">
                        <hr />
                        <div class="col-12 col-sm-3 r-mb-1 d-lbl">
                          <span class="lh27-5 font-15">最寄駅</span>
                          <span class="no-required">任意</span>
                        </div>
                        <div class="col-12 col-sm-8">
                          <div class="d-flex">
                            <div class="form-group w-80 r-w-100">
                              <Field
                                name="nearest_station_name"
                                v-model="model.nearest_station_name"
                                rules="max:255"
                                placeholder="JR山手線　東京"
                                class="form-control w-70 r-w-90 d-inline"
                              />
                      ...
                      <div class="row justify-content-center mb-4">
                        <hr />
                        <div class="col-12 col-sm-3 r-mb-1 d-lbl">
                          <span class="lh27-5 font-15">その他ご要望</span>
                          <span class="no-required">任意</span>
                        </div>
                        <div class="col-12 col-sm-8">
                          <div class="form-group">
                          ...
                          <div class="form-group font-11 lh-20 mt-3">
                            <div>
                    ...
                    <div class="col-12 text-center">
                      <div class="privacy-policy my-5 custom-radio event-link">
                        ...
                        <label
                          ...
                          for="policy"
                          class="text-decoration-underline font-15 lh-20"
                      ...
                      <div class="redirect-login mt-4 font-15 lh-20">
                        ログインの方は<a
                          :href="data.urlLogin"
                          title="ログインの方はこちら"
    ...
    <div
      class="background-over bg-register"
      :class="{ active: showOption }"
    ></div>
  </div>
</template>
