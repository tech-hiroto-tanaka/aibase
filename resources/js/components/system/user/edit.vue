                    ...
                    <div class="col-sm-6 d-flex align-items-center">
                      ...
                      >
                        <Field as="div" name="gender">
                          ...
                          />
                          <label :for="'gender' + index" class="ms-2">{{
                            item.label
                          }}</label>
                        </Field>
                      </div>
...
例）Web系の開発工程を希望。作業場所は〇〇駅から一時間圏内。希望月収は手取りで〇〇万円程度。"
                        ...
                        <div class="form-group font-11 mt-3">
                          <div>
                            弊社のお打ち合わせをご希望の場合は、可能な日時もしくは曜日や時間帯などご記入ください。
                          </div>
                          <div>（営業時間 平日9:00-18:00 土日祝除く。）</div>
                        </div>
                      </div>
                    </CRow>
                  </div>
  ...
  data: function () {
    return {
      ...
      model: {
        ...
        area_id:
          this.data.user.area_id != 0 && this.data.user.area_id != 1
            ? this.data.user.area_id
            : "",
